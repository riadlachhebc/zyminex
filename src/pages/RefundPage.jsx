    ...
    <div className="legal-page" id="refund-page">
      ...
      <section className="section">
        <div className="container legal-content">
          ...
          <p>We stand behind the quality of Forest IPTV. If you are not completely satisfied with our service, we offer a 7-day money-back guarantee for all new subscriptions.</p>
          ...
          <p>To request a refund, please contact our support team at support@forestiptv.pro or open a ticket through your account dashboard. Include your order number and the email address associated with your account.</p>
